...
double QDot2D::fCalcElementQ2DOpenFCI(int p, int q, int r, int s) {
    ...
    if(DELTA(iS1,iS4) && DELTA(iS2,iS3)) {
...
double QDot2D::fCalcElementQ2D(int p, int q, int r, int s) {
    ...
    if(DELTA(iS1,iS4) && DELTA(iS2,iS3)) {
        dElement2 = fCoulomb2D(iN1, iM1, iN2, iM2, iN4, iM4, iN3, iM3);
    }

    return dElement1 - dElement2;
}
...
*/
double QDot2D::fCoulomb2D(int iN1, int iM1, int iN2, int iM2, int iN4, int iM4, int iN3, int iM3) {
